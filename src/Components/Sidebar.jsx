  ...
  return (
    ...
    >
      <div className="py-5.5 lg:py-6.5 mt-[25px] flex items-center justify-between gap-2 px-6 lg:justify-center">
        <NavLink to="/">
          <img src={Pic} alt="My Image" className="h-[50px] w-[120px]" />
        </NavLink>
        <button
          ref={trigger}
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-3">
              ...
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-[10px] px-4 py-2 text-[17px] font-medium  duration-300 ease-in-out hover:bg-hover hover:text-[#FF8216] ${
                    pathname === "/" || pathname.includes("newsfeed")
                      ? "bg-hover text-[#FF8216]"
                      : "text-text"
                  }`}
                >
                  <MdOutlineDashboard size={24} color="currentColor" />
                  News Feed
                </NavLink>
              </li>
              {/* <!-- Menu Item Dashboard --> */}
              ...
              <li>
                ...
                >
                  <IoSearchOutline size={24} color="currentColor" />
                  Search
                </NavLink>
              </li>
              {/* <!-- Menu Item Search --> */}
              ...
              <li>
                ...
                >
                  <IoPeopleOutline size={24} color="currentColor" />
                  Job Post
                </NavLink>
              </li>
              {/* <!-- Menu Item Calendar --> */}
              ...
              <li>
                ...
                >
                  <IoCashOutline size={24} color="currentColor" />
                  Bids
                </NavLink>
              </li>
              {/* <!-- Menu Item Profile --> */}
              ...
              <li>
                ...
                >
                  <IoChatbubbleOutline size={24} color="currentColor" />
                  Chat
                </NavLink>
              </li>
              {/* <!-- Menu Item Tables --> */}
              ...
              <li>
                ...
                >
                  <IoWalletOutline size={24} color="currentColor" />
                  Payment
                </NavLink>
              </li>
              {/* <!-- Menu Item Settings --> */}
